...
namespace Restaurant.Business.Product.Repository
{
    ...
    {
        public RequestResult Save(Model.Product product, SqlConnection connection)
        {
        ...
        public RequestResult Update(Model.Product product, SqlConnection connection)
        {
            RequestResult validate = ProductDataValidation.isDataValid(product);
            if (!validate.isSuccess)
            {
        ...
        public List<Model.Product> FetchAll(SqlConnection connection)
        {
        ...
        public List<Model.Product> Filter(string filter, SqlConnection connection)
        {
            List<Model.Product> Product = new List<Model.Product>();
